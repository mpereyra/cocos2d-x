 ...
 * */
CC_DLL unsigned short* cc_utf8_to_utf16(const char* str_old, int length = -1, int* rUtf16Size = 0);
 ...
 * @returns the newly created utf8 string.
 * */
CC_DLL unsigned short* cc_utf16_from_utf8(const char* str_old, int length = -1, int* rUtf16Size = 0);

/**
 * Creates a utf32 string from a cstring.
 *
 * @param str_old   pointer to the start of a C string.
 *
 * @returns the newly created utf32 string.
 * */
CC_DLL unsigned long* cc_utf8_to_utf32(const char* str_old, int length = -1, int* rUtf16Size = 0);
