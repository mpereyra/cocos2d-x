...
void CCApplication::setResourceRootPath(const std::string& rootResDir)
{
    ...
    //ROB??//    std::vector<std::string> searchPaths = pFileUtils->getSearchPaths();
    //ROB??//    searchPaths.insert(searchPaths.begin(), m_resourceRootPath);
    //ROB??//    pFileUtils->setSearchPaths(searchPaths);
}
