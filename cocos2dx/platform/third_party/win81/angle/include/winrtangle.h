...
struct __declspec(uuid("736E7573-FD24-433F-811E-893B36B7A078")) IWinrtEglWindow : IUnknown
{
    ...
    virtual IDXGISwapChain* __stdcall GetSwapChain() = 0;
    virtual void __stdcall SetSwapChain(IDXGISwapChain* swapChain) = 0;
    virtual void __stdcall SetAngleDxgiFactory(IDXGIFactory2* dxgifactory) = 0;
    virtual IDXGIFactory2* __stdcall GetAngleDxgiFactory() = 0;
    virtual void __stdcall SetAngleD3DContext(ID3D11DeviceContext* d3dcontext) = 0;
    virtual ID3D11DeviceContext* __stdcall GetAngleD3DContext() = 0;
};
