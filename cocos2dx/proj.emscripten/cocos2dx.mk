...
CCFLAGS  += -MMD -Wall -fPIC -Qunused-arguments -s TOTAL_MEMORY=268435456 -s VERBOSE=1 -U__native_client__ -Wno-deprecated-declarations $(EXPORTED_FLAGS) $(JSLIBS) -s DISABLE_EXCEPTION_CATCHING=0 -s NO_EXIT_RUNTIME=1
CXXFLAGS += -MMD -Wall -fPIC -Qunused-arguments -s TOTAL_MEMORY=268435456 -s VERBOSE=1 -U__native_client__ -Wno-deprecated-declarations $(EXPORTED_FLAGS) $(JSLIBS) -s DISABLE_EXCEPTION_CATCHING=0 -std=c++11 -s NO_EXIT_RUNTIME=1
...
CCFLAGS += -O3 -s GL_UNSAFE_OPTS=0
CXXFLAGS += -O3 -s GL_UNSAFE_OPTS=0
